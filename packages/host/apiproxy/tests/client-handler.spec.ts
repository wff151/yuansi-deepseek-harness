...
function scriptedApi(overrides: {
  ...
  return {
    ...
    memory: {
      status: r => ok(r, { memoryCount: 0, injectContext: true, counts: { public: 0, shortTerm: 0, permanent: 0, portable: 0, evolution: 0 } }),
      list: r => ok(r, { entries: [] }),
      get: r => ok(r, { type: 'public', id: r.payload.id, title: '', summary: '', timestamp: '', data: {} }),
      delete: r => ok(r, { deleted: false }),
      update: r => ok(r, { type: 'public', id: r.payload.id, title: '', summary: '', timestamp: '', data: {} }),
      config: r => ok(r, { injectContext: true }),
    },
